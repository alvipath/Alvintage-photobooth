...
<div id="page1" class="screen active">
    <h1>Vyyntage Photobooth ✨</h1>
    <p>Pilih layout favoritmu, abadikan moment berhargamu!</p>
    
    
        </div><center>
 <button onclick="goToPage2()" style="background:#f4c2c2; color:#5a4a3b;">Lanjut →</button>
  </center>
</div>
...
<img width="619" height="6800" alt="image" src="https://github.com/user-attachments/assets/6100d9a0-ec7c-48b5-8870-371b4d894a55" />
